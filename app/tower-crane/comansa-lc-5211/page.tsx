...
export const metadata = {
  title: 'Comansa LC-5211 Specifications | Tower Cranes | lilfoot',
  description:
    'Load charts and specifications for the Comansa LC-5211 tower crane.',
};

export default function ComansaLC5211Page() {
  return (
    <div className="text-white">
      <div className="mb-8">
        <h1 className="mb-4 text-3xl font-bold text-white">
          Comansa LC-5211 Tower Crane
        </h1>
        <p className="max-w-3xl text-gray-400">
          The Comansa LC-5211 is a versatile flat-top tower crane known for its
          reliability and performance in various construction applications. This
          page will provide comprehensive specifications, load charts, and
      ...
      <div className="mb-8 flex flex-col items-center justify-center rounded-lg bg-gray-900 p-8">
        ...
        <p className="max-w-xl text-center text-gray-400">
          We're currently developing comprehensive content for the Comansa
          LC-5211 tower crane. Our team is working to provide accurate and
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-gray-900 p-6">
          ...
          <ul className="space-y-3 text-gray-400">
            ...
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Spanish engineering excellence
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Optimized for ease of transport and assembly
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
