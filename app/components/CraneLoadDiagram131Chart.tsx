...
const CraneLoadDiagram131Chart = () => {
  // Distance values (x-axis)
  const distances = [
    "65.6", "82", "98.4", "114.8", "128", "131.2"
  ];
  ...
  const fourPartLineData = [
    44092, 44092, 36597, 30424, 26676, 26676
  ];
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Terex SK 415-20 (128-131.2 ft Configuration) Load Capacity Chart',
        color: '#ffffff',
        font: {
          size: 16,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-gray-900 rounded-lg flex items-center justify-center p-4">
              ...
              >
                ...
                {/* Measurements */}
                <text x="220" y="140" fill="#53C03F" fontSize="12">101.7 ft</text>
                <text x="210" y="180" fill="#53C03F" fontSize="12">33.1 ft</text>
                <text x="320" y="140" fill="#53C03F" fontSize="12">128 ft to 131.2 ft</text>
                <text x="290" y="200" fill="#53C03F" fontSize="12">25,353 lbs - 27,558 lbs</text>
              </svg>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold text-white">Terex SK 415-20 (128-131.2 ft Configuration)</h3>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">101.7 ft</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">128 ft to 131.2 ft</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Load Capacities:</span>
                <span className="font-bold text-highlight">25,353 lbs - 27,558 lbs</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Load capacity table */}
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <h3 className="text-xl font-bold text-white mb-4">Load Capacity Table (128-131.2 ft)</h3>
...
export default CraneLoadDiagram131Chart; 