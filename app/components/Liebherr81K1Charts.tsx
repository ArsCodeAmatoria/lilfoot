...
const craneData = {
  ...
  loadCharts: {
    ...
    "LoadPlus": [
      { radius: 3.0, capacity: 6000 }, // kg
      { radius: 4.0, capacity: 6000 },
      { radius: 5.0, capacity: 6000 },
      { radius: 6.0, capacity: 6000 },
      { radius: 7.0, capacity: 6000 },
      { radius: 8.0, capacity: 5800 },
      { radius: 9.0, capacity: 5300 },
      { radius: 10.0, capacity: 4800 },
      { radius: 12.0, capacity: 4000 },
      { radius: 14.0, capacity: 3500 },
      { radius: 16.0, capacity: 3000 },
      { radius: 18.0, capacity: 2700 },
      { radius: 20.0, capacity: 2400 },
      ...
      { radius: 32.0, capacity: 1400 },
      { radius: 34.0, capacity: 1250 },
      { radius: 36.0, capacity: 1150 },
      { radius: 38.0, capacity: 1050 },
      { radius: 40.0, capacity: 950 },
      { radius: 42.0, capacity: 850 },
      { radius: 45.0, capacity: 750 },
    ],
