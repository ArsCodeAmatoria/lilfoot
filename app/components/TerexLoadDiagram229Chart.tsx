...
const TerexLoadDiagram229Chart = () => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Terex SK 415-20 (229.7 ft Configuration) Load Capacity Chart',
        color: '#ffffff',
        font: {
          size: 16,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black p-6 rounded-lg">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-gray-900 rounded-lg flex items-center justify-center p-4">
              ...
              >
                ...
                <text x="320" y="140" fill="#ef4444" fontSize="12">229.7 ft Max Reach</text>
                <text x="290" y="200" fill="#ef4444" fontSize="12">7,716 lbs Min Capacity</text>
              </svg>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold text-white">Terex SK 415-20 (229.7 ft Configuration)</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-red-500">229.7 ft</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Minimum Capacity at Max Reach:</span>
                <span className="font-bold text-red-500">7,716 lbs</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Load capacity table */}
      <div>
        <h3 className="text-xl font-bold text-white mb-4">Load Capacity Table (229.7 ft Configuration)</h3>
        <div className="overflow-x-auto rounded-md">
          <Table className="border-collapse">
            <TableCaption>Load capacity chart for Terex SK 415-20 (229.7 ft configuration) showing capacities in pounds at different distances</TableCaption>
            ...
            <TableBody>
              <TableRow className="bg-gray-900/30">
                ...
                {twoPartLineData.map((value, index) => (
                  <TableCell key={index} className="border border-gray-800 text-center">
                    {index === twoPartLineData.length - 1 ? 
              ...
              <TableRow>
                ...
                {fourPartLineData.map((value, index) => (
                  <TableCell key={index} className="border border-gray-800 text-center">
                    {index === fourPartLineData.length - 1 ? 
                      <span className="font-bold text-red-500">{value.toLocaleString()}</span> : 
                      value.toLocaleString()}
                  </TableCell>
                ))}
...
export default TerexLoadDiagram229Chart; 