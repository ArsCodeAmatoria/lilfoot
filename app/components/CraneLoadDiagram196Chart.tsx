...
const CraneLoadDiagram196Chart = () => {
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Terex SK 415-20 (193.6-196.9 ft Configuration) Load Capacity Chart',
        color: '#ffffff',
        font: {
          size: 16,
      ...
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold text-white">Terex SK 415-20 (193.6-196.9 ft Configuration)</h3>
...
export default CraneLoadDiagram196Chart; 