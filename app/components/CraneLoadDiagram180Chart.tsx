...
const CraneLoadDiagram180Chart = () => {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-gray-900 rounded-lg flex items-center justify-center p-4">
              ...
              >
                ...
                {/* Measurements */}
                <text x="220" y="140" fill="#ef4444" fontSize="12">147.6 ft</text>
                <text x="210" y="180" fill="#ef4444" fontSize="12">33.1 ft</text>
                <text x="320" y="140" fill="#ef4444" fontSize="12">177.2 ft to 180.5 ft</text>
                <text x="290" y="200" fill="#ef4444" fontSize="12">15,653 lbs - 17,196 lbs</text>
              </svg>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-red-500">177.2 ft to 180.5 ft</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Load Capacities:</span>
                <span className="font-bold text-red-500">15,653 lbs and 17,196 lbs</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Load capacity table */}
      <div>
        <h3 className="text-xl font-bold text-white mb-4">Load Capacity Table (177.2-180.5 ft Configuration)</h3>
