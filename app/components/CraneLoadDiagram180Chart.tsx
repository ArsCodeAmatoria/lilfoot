...
const CraneLoadDiagram180Chart = () => {
  ...
  const twoPartLineData = [
    22046, 22046, 22046, 22046, 22046, 19401, 
    17196, 15653, 17196
  ];
  
  // Load values for 4-part line (y-axis)
  const fourPartLineData = [
    44092, 41447, 33290, 27558, 23369, 20062, 
    17417, 15653, 17196
  ];
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Terex SK 415-20 (177.2-180.5 ft Configuration) Load Capacity Chart',
        color: '#ffffff',
        font: {
          size: 16,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-gray-900 rounded-lg flex items-center justify-center p-4">
              ...
              >
                ...
                {/* Measurements */}
                <text x="220" y="140" fill="#53C03F" fontSize="12">149.9 ft</text>
                <text x="210" y="180" fill="#53C03F" fontSize="12">33.1 ft</text>
                <text x="320" y="140" fill="#53C03F" fontSize="12">177.2 ft to 180.5 ft</text>
                <text x="290" y="200" fill="#53C03F" fontSize="12">15,653 lbs - 17,196 lbs</text>
              </svg>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold text-white">Terex SK 415-20 (177.2-180.5 ft Configuration)</h3>
            <div className="space-y-2">
              ...
              <div className="bg-gray-900 p-3 rounded-md">
                <span className="font-medium text-white">BG (6,834 lbs), 7 Sections</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">149.9 ft</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">177.2 ft to 180.5 ft</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Load Capacities:</span>
                <span className="font-bold text-highlight">15,653 lbs - 17,196 lbs</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Load capacity table */}
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <h3 className="text-xl font-bold text-white mb-4">Load Capacity Table (177.2-180.5 ft)</h3>
...
export default CraneLoadDiagram180Chart; 