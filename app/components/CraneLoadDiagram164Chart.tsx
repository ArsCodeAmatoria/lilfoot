...
const CraneLoadDiagram164Chart = () => {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md aspect-[4/3] bg-gray-900 rounded-lg flex items-center justify-center p-4">
              ...
              >
                ...
                {/* Measurements */}
                <text x="220" y="140" fill="#53C03F" fontSize="12">160.8 ft</text>
                <text x="210" y="180" fill="#53C03F" fontSize="12">33.1 ft</text>
                <text x="320" y="140" fill="#53C03F" fontSize="12">164.1 ft</text>
                <text x="290" y="200" fill="#53C03F" fontSize="12">18,960 lbs - 20,503 lbs</text>
              </svg>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">160.8 ft</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-highlight">164.1 ft</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Load Capacities:</span>
                <span className="font-bold text-highlight">18,960 lbs - 20,503 lbs</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Load capacity table */}
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <h3 className="text-xl font-bold text-white mb-4">Load Capacity Table (160.8-164.1 ft)</h3>
