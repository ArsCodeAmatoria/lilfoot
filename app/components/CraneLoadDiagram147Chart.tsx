...
const CraneLoadDiagram147Chart = () => {
  // Distance values (x-axis)
  const distances = [
    "65.6", "82", "98.4", "114.8", "131.2", "144.4", 
    "147.6"
  ];
  ...
  const fourPartLineData = [
    44092, 44092, 36156, 29983, 25353, 22487, 
    22487
  ];
  ...
  const options = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: 'Terex SK 415-20 (144.4-147.6 ft Configuration) Load Capacity Chart',
        color: '#ffffff',
        font: {
          size: 16,
      ...
      <div className="bg-black p-6 rounded-lg border border-gray-800">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold text-white">Terex SK 415-20 (144.4-147.6 ft Configuration)</h3>
...
export default CraneLoadDiagram147Chart; 