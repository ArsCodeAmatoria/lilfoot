...
export const metadata = {
  title: 'Potain HDT-80 Specifications | Self-Erect Tower Cranes | lilfoot',
  description:
    'Load charts and specifications for the Potain HDT-80 self-erecting tower crane.',
};

export default function PotainHDT80Page() {
  return (
    <div className="text-white">
      <div className="mb-8">
        <h1 className="mb-4 text-3xl font-bold text-white">
          Potain HDT-80 Self-Erect Tower Crane
        </h1>
        <p className="max-w-3xl text-gray-400">
          The Potain HDT-80 is a high-capacity self-erecting tower crane
          designed for demanding construction projects. This page will provide
      ...
      <div className="mb-8 flex flex-col items-center justify-center rounded-lg bg-gray-900 p-8">
        ...
        <p className="max-w-xl text-center text-gray-400">
          We're currently developing comprehensive content for the Potain HDT-80
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-gray-900 p-6">
          ...
          <ul className="space-y-3 text-gray-400">
            ...
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Optimized for major construction sites
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              State-of-the-art operator controls
            </li>
          </ul>
        </div>
      </div>
