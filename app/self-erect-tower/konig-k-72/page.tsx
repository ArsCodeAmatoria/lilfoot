...
export const metadata = {
  title: 'Konig K 72 Specifications | Self-Erect Tower Cranes | lilfoot',
  description:
    'Load charts and specifications for the Konig K 72 self-erecting tower crane.',
};

export default function KonigK72Page() {
  return (
    <div className="text-white">
      <div className="mb-8">
        <h1 className="mb-4 text-3xl font-bold text-white">
          Konig K 72 Self-Erect Tower Crane
        </h1>
        <p className="max-w-3xl text-gray-400">
          The Konig K 72 is a versatile and efficient self-erecting tower crane
          designed for medium-sized construction projects. This page will
          provide comprehensive specifications, load charts, and operational
          guidelines for crane operators.
        </p>
      </div>
      ...
      <div className="mb-8 flex flex-col items-center justify-center rounded-lg bg-gray-900 p-8">
        ...
        <p className="max-w-xl text-center text-gray-400">
          We're currently developing comprehensive content for the Konig K 72
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-lg bg-gray-900 p-6">
          ...
          <ul className="space-y-3 text-gray-400">
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Optimized for medium-sized projects
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Balanced reach and capacity
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
              Streamlined erection process
            </li>
            <li className="flex">
              <span className="mr-2 font-bold text-highlight">•</span>
