...
export const metadata = {
  title: 'Potain GTMR 331C Specifications | Self-Erect Tower Cranes | lilfoot',
  description:
    'Load charts and specifications for the Potain GTMR 331C self-erecting tower crane.',
};

export default function PotainGTMR331CPage() {
  return (
    <div className="text-white">
      <div className="mb-8">
        <h1 className="mb-4 text-3xl font-bold text-white">
          Potain GTMR 331C Self-Erect Tower Crane
        </h1>
        <p className="max-w-3xl text-gray-400">
          The Potain GTMR 331C is a high-capacity self-erecting tower crane
      ...
      <div className="mb-8 flex flex-col items-center justify-center rounded-lg bg-gray-900 p-8">
        ...
        <p className="max-w-xl text-center text-gray-400">
          We're currently developing comprehensive content for the Potain GTMR
          331C self-erect tower crane. Our team is working to provide accurate
