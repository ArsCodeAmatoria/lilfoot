...
export const metadata = {
  title: 'Konig K1035TKH Specifications | Self-Erect Tower Cranes | lilfoot',
  description:
    'Load charts and specifications for the Konig K1035TKH self-erecting tower crane.',
};

export default function KonigK1035TKHPage() {
  return (
    <div className="text-white">
      <div className="mb-8">
        <h1 className="mb-4 text-3xl font-bold text-white">
          Konig K1035TKH Self-Erect Tower Crane
        </h1>
        <p className="max-w-3xl text-gray-400">
          The Konig K1035TKH is a powerful self-erecting tower crane known for
          its exceptional lifting capabilities and advanced features. This page
      ...
      <div className="mb-8 flex flex-col items-center justify-center rounded-lg bg-gray-900 p-8">
        ...
        <p className="max-w-xl text-center text-gray-400">
          We're currently developing comprehensive content for the Konig
          K1035TKH self-erect tower crane. Our team is working to provide
